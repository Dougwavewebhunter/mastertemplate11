      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            <img src={logo.url} alt="Granite Installations" className="h-10 sm:h-12 w-auto transition-transform group-hover:scale-105" />
            <span className={`hidden sm:block font-display font-bold leading-tight ${scrolled ? "text-[color:var(--ink)]" : "text-white"}`}>
              <span className="block text-sm">GRANITE INSTALLATIONS</span>
              <span className="block text-[10px] tracking-wider opacity-70">PREMIUM STONE SOLUTIONS</span>
            </span>
          </Link>
          ...
          <div className="flex items-center justify-between p-5 border-b border-[color:var(--border)]">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-sm leading-tight">
                GRANITE INSTALLATIONS<br />
                <span className="text-[10px] opacity-60 tracking-wider">PREMIUM STONE SOLUTIONS</span>
              </span>
            </div>
