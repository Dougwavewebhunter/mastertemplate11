        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="font-display font-bold">GRANITE INSTALLATIONS</div>
                <div className="text-[10px] tracking-wider opacity-70">PREMIUM STONE SOLUTIONS</div>
              </div>
            </div>
            <p className="text-sm text-white/75 leading-relaxed">
              Built for Elegance. Made to Last. Premium granite, marble, quartz and porcelain installations across South Africa.
            </p>
